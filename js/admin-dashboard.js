...
function setupEventListeners() {
    ...
    if (sidebarCloseBtn) {
        ...
        console.log('✅ Sidebar close button setup');
    }
            ...
            <td>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <button class="dropdown-item" onclick="viewOrderDetail('${order.id}')">
            ...
            <td>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li>
                            <button class="dropdown-item" onclick="updateOrderStatus('${order.id}', 'completed')">
        ...
        row.innerHTML = `
            ...
            <td>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <button class="dropdown-item" onclick="viewCustomerOrders('${customer.email}')">
                                <i class="bi bi-list-ul me-2"></i>Lihat Pesanan
                            </button>
                        </li>
                        <li><hr class="dropdown-divider"></li>
                        <li>
                            <button class="dropdown-item text-info" onclick="alert('Hubungi: ${customer.telepon}')">
